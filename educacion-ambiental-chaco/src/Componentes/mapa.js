    ...
    return(
        <div className="row mx-auto">
           ...
           <div className="col-md-6">
               <br/>
               <div className="bg-white rounded-circle p-4 animated bounceInDown slower" style={{maxWidth:"400px",margin:"auto"}}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="pt-4  mb-5 mx-1 text-center" width="400px" height='300px' viewBox="0 0 337.792 288.902" style={{marginRight:"100px",marginLeft:"100px"}} >
